...
<section class="content-wrap">
    ...
    <section class="youplay-banner banner-top youplay-banner-parallax">
        <div class="image" style="background-image: url('/web/uploads/images/banner-bg.jpg')">
        </div>
    ...
    <div class="youplay-carousel" data-autoplay="5000">
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="/web/uploads/images/game-dark-souls-ii-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="/web/uploads/images/game-lords-of-the-fallen-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="/web/uploads/images/game-middle-eart-shadow-of-mordor-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="/web/uploads/images/game-soul-sacrifice-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="/web/uploads/images/game-the-witcher-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="/web/uploads/images/game-diablo-iii-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="/web/uploads/images/game-dragons-dogma-500x375.jpg" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
    ...
    <section class="youplay-banner youplay-banner-parallax small">
        <div class="image" style="background-image: url('/web/uploads/images/banner-witcher-3.jpg');">
        </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="owl-carousel" data-autoplay="6000">
                            <div class="item">
                                <a href="#">
                                    <img src="/web/uploads/images/partner-logo-1.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="/web/uploads/images/partner-logo-2.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="/web/uploads/images/partner-logo-3.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="/web/uploads/images/partner-logo-4.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="/web/uploads/images/partner-logo-5.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="/web/uploads/images/partner-logo-6.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="/web/uploads/images/partner-logo-7.png" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="/web/uploads/images/partner-logo-8.png" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
